...
import { deriveMasterKey } from './lib/crypto/kdf.ts';
...
export function App() {
  ...
  // -------------------------------------------------------------------------
  if (screen === 'register') {
    const isAccessAllowed = !!userConfig || isMasterAccessUnlocked;
    ...
    return (
      <div className="min-h-screen bg-[#08090a] flex flex-col items-center justify-center p-4 sm:p-6 text-zinc-100 selection:bg-white/20 selection:text-white">
        ...
        >
          ...
          {/* Restricted Private Instance Overlay (for unrecognized devices without shortcut unlock) */}
          {!isAccessAllowed && (
